  ...
  return (
    <>
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        {/* Service Image */}
        <ImageBackground
          source={require('../assets/images/vaccination1.png')} // Replace with the path to your background image
        ...
        {/* Footer Actions */}
        <BottomBookButton serviceType="Vaccination" selectedDate={selectedDate} />
      </ScrollView>
    </>
  );
};
